...
class heliVisualizationWithFilteration:
    ...
    def visualization_from_geojson(filepath,hover_properties,map_style='dark'):
        ...
        comb={'botton_bg_color':'#444544','text_color1':'#DBE1DE','dropdown_color':'#8C8C8C','botton_on_map_color':'#333333'}
        try:
        ...
        if response.status_code == 200:
            ...
            app.layout = html.Div(style={'background-image':'url("/assets/wallpaper.png")',
            ...
            ## map for index page
            index_page = html.Div([
                html.Img(src=app.get_asset_url('logo_transparent01.png'),style={'width':'200px','height':'60px'}),
                html.H1("Welcome to heli visualization dashboard!!!!",style={"text-align":"center","margin-top":"100px","color":"white","text-shadow": "2px 2px 2px gray,2px 2px 2px gray","font-size":"60px",'font-family':'TimesNewRoman','font-weight': '700'}),
                ...
                dcc.Link('ScatterMap', href='/ScatterMap',style={"margin-left":"5%","background-color": comb['botton_bg_color'],"color": comb['text_color1'],"padding": "30px 40px","text-align": "center","text-decoration": "none","font-size":"40px"}),
                ...
                dcc.Link('HexagonMap', href='/HexagonMap',style={"margin-left":"5%","margin-bottom":"100px","background-color": comb['botton_bg_color'],"color": comb['text_color1'],"padding": "30px 40px","text-align": "center","text-decoration": "none","display": "inline","font-size":"40px"}),
                dcc.Link('LineMap', href='/lineMap',style={"margin-left":"5%","margin-bottom":"100px","background-color": comb['botton_bg_color'],"color": comb['text_color1'],"padding": "30px 40px","text-align": "center","text-decoration": "none","display": "inline","font-size":"40px"}),
            ...
            for i in columns_name:
                scatter_map_children_list.append(html.Div(children=i, className="menu-title",
                                style={"text-align":"center","color":comb['text_color1'],"margin-top":"7px","padding": "0px 20px",'font-family':'TimesNewRoman','font-weight': '500'}),)
            ...
            scatter_map_children_list.append(dbc.Row([dbc.Col(dcc.Link('DensityMap', href='/DensityMap',style={"background-color":comb['botton_on_map_color'],"color": comb['text_color1'],"padding": "14px 20px","text-align": "center","text-decoration": "none","display": "inline"}),width={'size':3.5,'offset':0}),
                    ...
                    dbc.Col(dcc.Link('LineMap', href='/lineMap',style={"background-color":comb['botton_on_map_color'],"color": comb['text_color1'],"padding": "14px 20px","text-align": "center","text-decoration": "none","display": "inline"}),width={'size':3.5,'offset':0})],justify="center",style={'margin-top':'15%','margin-bottom':'10%'}))
            scatter_map_layout = html.Div([dbc.Row([dbc.Col(html.Img(src=app.get_asset_url('logo_transparent01.png'),style={'width':'120px','height':'36px'})),
                dbc.Col(html.H3("Scatter Map",style={"margin-top":"2%","color":"white","font-size":"40px",'font-family':'TimesNewRoman','font-weight': '700'}))],justify="start"),
            ...
            density_map_children_list.append(dbc.Row([dbc.Col(dcc.Link('ScatterMap', href='/ScatterMap',style={"background-color":comb['botton_on_map_color'],"color": comb['text_color1'],"padding": "14px 20px","text-align": "center","text-decoration": "none","display": "inline"}),width={'size':3.5,'offset':0}),
                    dbc.Col(dcc.Link('HexagonMap', href='/HexagonMap',style={"background-color":comb['botton_on_map_color'],"color": comb['text_color1'],"padding": "14px 20px","text-align": "center","text-decoration": "none","display": "inline"}),width={'size':3.5,'offset':0}),
                    dbc.Col(dcc.Link('LineMap', href='/lineMap',style={"background-color":comb['botton_on_map_color'],"color": comb['text_color1'],"padding": "14px 20px","text-align": "center","text-decoration": "none","display": "inline"}),width={'size':3.5,'offset':0})],justify="center",style={'margin-top':'15%','margin-bottom':'10%'}))
            density_map_layout = html.Div([dbc.Row([dbc.Col(html.Img(src=app.get_asset_url('logo_transparent01.png'),style={'width':'120px','height':'36px'})),
                dbc.Col(html.H3("Density Map",style={"margin-top":"2%","color":"white","font-size":"40px",'font-family':'TimesNewRoman','font-weight': '700'}))],justify="start"),
            ...
            line_map_children_list.append(dbc.Row([dbc.Col(dcc.Link('ScatterMap', href='/ScatterMap',style={"background-color":comb['botton_on_map_color'],"color": comb['text_color1'],"padding": "14px 15px","text-align": "center","text-decoration": "none","display": "inline"}),width={'size':3.5,'offset':0}),
                    ...
                    dbc.Col(dcc.Link('HexagonMap', href='/HexagonMap',style={"background-color":comb['botton_on_map_color'],"color": comb['text_color1'],"padding": "14px 15px","text-align": "center","text-decoration": "none","display": "inline"}),width={'size':3.5,'offset':0})],justify="center",style={'margin-top':'15%','margin-bottom':'10%'}))
            line_map_layout = html.Div([dbc.Row([dbc.Col(html.Img(src=app.get_asset_url('logo_transparent01.png'),style={'width':'120px','height':'36px'})),
                dbc.Col(html.H3("Line Map",style={"margin-top":"2%","color":"white","font-size":"40px",'font-family':'TimesNewRoman','font-weight': '700'}))],justify="start"),
            ...
            hexa_map_children_list.append(dbc.Row([dbc.Col(dcc.Link('LineMap', href='/lineMap',style={"background-color":comb['botton_on_map_color'],"color": comb['text_color1'],"padding": "14px 20px","text-align": "center","text-decoration": "none","display": "inline"}),width={'size':3.5,'offset':0}),
                    ...
                    dbc.Col(dcc.Link('ScatterMap', href='/ScatterMap',style={"background-color":comb['botton_on_map_color'],"color": comb['text_color1'],"padding": "14px 20px","text-align": "center","text-decoration": "none","display": "inline"}),width={'size':3.5,'offset':0})],justify="center",style={'margin-top':'15%','margin-bottom':'10%'}))
            hexagon_map_layout = html.Div([dbc.Row([dbc.Col(html.Img(src=app.get_asset_url('logo_transparent01.png'),style={'width':'120px','height':'36px'})),
                dbc.Col(html.H3("Hexagon Map",style={"margin-top":"2%","color":"white","font-size":"40px",'font-family':'TimesNewRoman','font-weight': '700'}))],justify="start"),
